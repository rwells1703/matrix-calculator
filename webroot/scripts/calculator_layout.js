...
calculator_layout = function()
{
	...
	self.createEquationDiv = function ()
	{
		...
		var addItemButtons = [];
		addItemButtons.push(layout.createButton("Scalar", calculator_build.addScalar));
		addItemButtons.push(layout.createButton("Grid", calculator_build.addGrid));
		addItemButtons.push(layout.createButton("Operation", calculator_build.addOperation));
		addItemButtons.push(layout.createButton("Bracket", calculator_build.addBracket));
		...
		var clearButton = layout.createButton("Clear", clearButtonClick);
		...
		var exportButton = layout.createButton("Export", exportButtonClick);
